...
#check amount of memory, proc meminfo should always be in terms of KB
        ...
        echo -e "memtotal $memtotal \n memfree $memfree"
        free=$(($memfree / $memtotal))
        percentfree=$((free * 100))
        echo "Precent free $percentfree%"
...
#If niether the vault nor consul hcl exist, script should have exited on find_hcl function. 
...
elif [[ memtotal < 8388608 ]] && [[ -f /etc/consul.d/consul.hcl ]]
then
...
#========================
#
#BREAKDOWN FUNCTIONS AND ADD MENU
#
